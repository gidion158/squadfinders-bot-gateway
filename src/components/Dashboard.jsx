...
const Dashboard = (props) => {
  ...
  }, [loading, error, messagesChartData, platformDistribution, aiStatusDistribution, hasAccess]);
  ...
  if (!hasAccess) {
    return React.createElement('div', { 
      ...
      React.createElement('h2', { key: 'title', style: { marginBottom: '10px' }}, 'Access Denied'),
      React.createElement('p', { key: 'message', style: { margin: 0 }}, 'You do not have permission to view the dashboard.')
    ]);
  }
  ...
  return React.createElement('div', { style: { padding: '20px', backgroundColor: '#f8f9fa', minHeight: '100vh' }}, [
    ...
    React.createElement('div', { key: 'stats', style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginBottom: '40px' }}, [
      ...
      React.createElement(StatBox, { key: 'pendingMessages', title: 'Pending AI', value: stats?.pendingMessages || 0, color: '#ffd93d', icon: '⏳' }),
