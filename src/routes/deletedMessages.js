 ...
 */
router.get('/', authMiddleware, deletedMessageController.getAll);
 ...
 */
router.get('/stats', authMiddleware, deletedMessageController.getStats);
 ...
 */
router.get('/daily', authMiddleware, deletedMessageController.getDailyStats);
 ...
 */
router.get('/:id', authMiddleware, deletedMessageController.getById);
