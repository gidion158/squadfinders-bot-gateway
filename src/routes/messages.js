 ...
 */
router.get('/valid-since', authMiddleware, messageController.getValidSince);

/**
 * @swagger
 * /api/messages/unprocessed:
 *   get:
 *     summary: Get unprocessed messages for AI processing
 *     tags: [Messages]
 *     security:
 *       - basicAuth: []
 ...
 */
router.get('/unprocessed', authMiddleware, messageController.getUnprocessed);
